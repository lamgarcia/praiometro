...
# BACKLOG RESUMIDO - Passar para KANBAN
...
# **** folium está utilizando a versão v4 do font awesome:
...
st.subheader('Planeje suas férias perfeitas,' +
             'escolhendo as melhores praias para cada mês.')
st.subheader('Encontre as praias ideais para sua viagem, escolhendo o mês' +
             'perfeito para garantir férias ensolaradas, com pouca chuva e temperaturas agradáveis.')
